  ...
  return (
    <header className="absolute top-0 left-0 w-full z-50 py-6 border-b border-transparent">
      <div className="container mx-auto px-6 md:px-12 xl:px-24 flex items-center justify-between">
        <div className="font-anton text-4xl tracking-widest uppercase text-white">
          Body Reset
        </div>
        ...
        <button className="hidden md:inline-flex px-6 py-3 bg-accent hover:bg-accent-hover text-white font-bold rounded-xl transition-colors shadow-lg cursor-pointer">
          Diagnóstico Gratis
        </button>
      </div>
    </header>
