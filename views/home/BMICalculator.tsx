...
export default function BMICalculator() {
  ...
  if (bmi < 18.5) {
    ...
    description = 'Rango de sobrepeso. Un plan personalizado puede prevenir riesgos de salud.';
  } else {
    category = 'Obesidad';
    colorClass = 'text-rose-600';
    borderClass = 'border-rose-200';
    bgClass = 'bg-rose-50/50';
    description = 'Rango de obesidad. Le sugerimos agendar una valoración médica integral.';
  }
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center relative z-10">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <p className="text-slate-600 text-sm md:text-base leading-relaxed font-medium">
              ...
              <strong className="text-slate-900">27 kg/m²</strong> puede sugerir sobrepeso. 
              Conoce tu resultado y recibe orientación de nuestros especialistas.
            </p>
            ...
            <div className="space-y-6 pt-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-lg font-black text-primary">
                    {weight} <span className="text-xs font-medium text-slate-400">kg</span>
                  </span>
                </div>
                <input
                  type="range"
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-lg font-black text-primary">
                    {height} <span className="text-xs font-medium text-slate-400">cm</span>
                  </span>
                </div>
                <input
                  type="range"
          ...
          <div className="lg:col-span-5">
            <div className={`rounded-3xl p-6 md:p-8 border ${borderClass} ${bgClass} transition-all duration-300 flex flex-col items-center text-center shadow-inner`}>
              ...
              <div className="relative flex items-center justify-center mb-4">
                {/* Big Display Number */}
                <span className={`text-6xl md:text-7xl font-black tracking-tight ${colorClass} transition-colors duration-300`}>
                  {roundedBmi}
                </span>
              ...
              <div className={`px-4 py-1.5 rounded-full text-xs font-extrabold uppercase tracking-wider bg-white border ${borderClass} ${colorClass} shadow-sm mb-4 transition-all duration-300`}>
                {category}
              </div>
