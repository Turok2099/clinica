          ...
          <div className="lg:col-span-5 space-y-8 text-left">
            <div>
              ...
              <h2 className="text-slate-900 text-4xl md:text-5xl font-extrabold tracking-tight mb-6 leading-tight">
                Es tiempo de atender tu salud.
              </h2>
              <p className="text-slate-600 text-lg leading-relaxed font-medium">
                Déjanos tus datos para que nuestro equipo médico pueda
                contactarte y brindarte una evaluación personalizada de tu caso.
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100 flex gap-3 items-start max-w-md">
              ...
              <p className="text-xs text-slate-500 font-medium leading-relaxed">
                <strong>Privacidad de Datos:</strong> CIP cumple estrictamente
                con el resguardo de información clínica. Tus datos serán
                tratados de manera confidencial y profesional únicamente para
                fines de tu consulta médica.
              </p>
            </div>
          </div>
                ...
                <div className="flex flex-col items-center text-center py-8 space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-slate-600 font-medium max-w-md">
                      Gracias por escribirnos. Nuestro equipo médico evaluará
                      tus datos y se pondrá en contacto contigo vía WhatsApp o
                      teléfono en menos de 24 horas hábiles.
                    </p>
                  </div>
                  <button
                  ...
                  <div className="space-y-2 text-left">
                    <label className="flex items-start gap-3 cursor-pointer select-none">
                      ...
                      <span className="text-xs text-slate-500 font-medium leading-tight">
                        ...
                        y autorizo el contacto clínico.
                      </span>
                    </label>
