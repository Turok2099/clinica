...
export default function Location() {
  return (
    <section className="bg-[#FDF8F2] py-24 px-6 md:px-12 xl:px-24">
      <div className="container mx-auto max-w-6xl">
        
        {/* Section Header */}
        <div className="text-center mb-16">
          <h2 className="text-[#3E332A] text-4xl md:text-5xl font-extrabold tracking-tight mb-4">
            Nuestra Clínica CIP
          </h2>
          <p className="text-[#7A6A58] text-lg max-w-2xl mx-auto font-medium">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 items-stretch bg-white rounded-3xl overflow-hidden border border-[#EBE3D5]/80 shadow-xl shadow-stone-200/50">
          
          {/* Info Column (spans 2) */}
          <div className="lg:col-span-2 p-8 lg:p-12 flex flex-col justify-center space-y-10 relative z-10 bg-white">
            
            <div className="space-y-4">
              <div className="flex items-center gap-3 text-[#3E332A] font-bold text-xl mb-2">
                <div className="w-10 h-10 rounded-xl bg-[#C8A97E]/10 flex items-center justify-center">
                  <MapPin className="w-5 h-5 text-[#C8A97E]" />
                </div>
                Dirección
              </div>
              <p className="text-[#7A6A58] leading-relaxed font-medium pl-13">
          ...
          <div className="lg:col-span-3 min-h-[450px] relative w-full h-full">
            ...
            <div className="absolute inset-0 border-l border-[#EBE3D5] pointer-events-none z-10 hidden lg:block" />
            <iframe 
