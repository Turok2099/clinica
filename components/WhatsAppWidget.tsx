...
export default function WhatsAppWidget() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-4 pointer-events-none">
      {/* Tooltip message */}
      <div className="bg-white px-4 py-3 rounded-2xl shadow-xl border border-slate-100 pointer-events-auto animate-fade-in-up origin-bottom-right hidden sm:block">
        <p className="text-sm text-slate-700 font-medium">
          ¿Dudas sobre el tratamiento? <strong className="text-slate-900 block">Chatea con nosotros</strong>
        </p>
      </div>
